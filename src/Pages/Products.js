        ...
        <div className='Customers'>
            ...
            <div className='wrapper'>
                ...
                <form onSubmit={handleSubmit} className='customer-form'>
                        <button onClick={handleOpen} className='add-customer-btn' name="Add" type='submit' value="Add">Add Products</button>
                </form>
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              <TableCell align="right">{(row.taxable ? "Taxable" : "Non Taxable")}</TableCell>
